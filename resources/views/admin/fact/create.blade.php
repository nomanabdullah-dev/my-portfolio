...
<form class="form-horizontal form-label-left" action="{{ route('admin.fact.store') }}" method="POST">
@csrf
    <div class="form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="icon">Icon
      </label>
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="icon" name="icon" class="form-control col-md-7 col-xs-12" value="">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="number" name="number" class="form-control col-md-7 col-xs-12" value="">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="title1" name="title1" class="form-control col-md-7 col-xs-12">
      </div>
    </div>
    <div class="form-group">
      <label for="title2" class="control-label col-md-3 col-sm-3 col-xs-12">Title2 </label>
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="title2" class="form-control col-md-7 col-xs-12" type="text" name="title2" value="">
      </div>
    </div>
